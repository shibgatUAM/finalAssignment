...
class AccountController extends Controller
{
    ...
    public function authenticate(Request $request)
    {
        ...
        if ($validator->passes()) {
            if (Auth::attempt([
                ...
                return redirect()->route('account.login')->with('error', 'Either Email or Pasword is incorrect');
            }
        } else {
    ...
    public function saveJob(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            session()->flash('success', 'Job addes successfully.');
    ...
    public function processForgotPassword(Request $request)
    {
        ...
        return redirect()->route('account.forgotPassword')
                        ->with('success', 'Reset Password has been sent to your mail');
    }
