                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="textarea" name="responsibilty" id="responsibilty" cols="5" rows="5" placeholder="Responsibility"></textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    ...
                                    <select name="experience" id="experience" class="form-control">
                                        ...
                                        <option value="10_plus Years">10+ Years</option>
                                    </select>
                                    <p></p>
                                </div>
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="date" placeholder="" id="deadline" name="deadline" class="form-control">
                                </div>
                            </div>
