    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1 class="text-warning">Find your dream job</h1>
                <p class="text-danger">Thounsands of jobs available.</p>
                ...
                <div class="row">
                    ...
                    <div class=" col-md-3 mb-xs-3 mb-sm-3 mb-lg-0">
                        <div class="d-grid gap-2">
                            {{-- <a href="jobs.html" class="btn btn-success btn-block">Search</a> --}}
                                    ...
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="d-grid mt-3">
                                                <a href="{{ route('jobDetail', $featuredJob->id) }}" class="btn btn-success btn-lg">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="d-grid mt-3">
                                                <a href="{{ route('jobDetail', $latestJob->id) }}" class="btn btn-success btn-lg">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
