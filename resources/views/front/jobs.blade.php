            ...
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                <form action="" name="searchForm" id="searchForm">
                    <div class="card border-0 shadow p-4">
                        ...
                        <button type="submit" class="btn btn-success">Search</button>  <hr>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="bg-light p-3 border">
                                               ...
                                               {{--  <p>Category: {{ $job->category->name }}</p> --}}
                                                ...
                                                <p>Deadline: {{ \Carbon\Carbon::parse($job->deadline)->format('d M, Y') }}</p>

                                                @if (!is_null($job->salary))
                                                <p class="mb-0">
                                                    <span class="fw-bolder">Salary: {{ $job->salary }}</span>
                                                </p> 
                                                @endif
                                            </div>
        
                                            <div class="d-grid mt-3">
                                                <a href="{{ route('jobDetail', $job->id) }}" class="btn btn-success btn-lg">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
