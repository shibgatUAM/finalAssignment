                ...
                <div class="card shadow border-0">
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @if (Auth::check())
                                <a href="#" onclick="applyJob({{ $job->id }})" class="btn btn-success">Apply</a>
                            @else
                                <a href="javascript:void(0);" class="btn btn-success disabled">Login to Apply</a>
                            @endif
                        </div>
                    </div>
                </div>
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                ...
                                @if (!empty($job->company_website))
                                    <li>Webite: <span><a href="http://{{ $job->company_website }}">{{ $job->company_website }}</a></span></li>
                                @endif
                            </ul>
                        </div>
                    </div>
