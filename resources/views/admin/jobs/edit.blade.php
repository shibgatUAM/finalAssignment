                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="textarea" name="responsibilty" id="responsibilty" cols="5" rows="5" placeholder="Responsibility">{{ $job->responsibilty }}</textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="date" value="{{ $job->deadline }}" id="deadline" name="deadline" class="form-control">
                                </div>
                            </div>
